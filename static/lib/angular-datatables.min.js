...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "datatables"), function (a, b, c, d) {
            ...
            function i() {
                ...
                return a.all([a.when(h.dtOptions), a.when(h.dtColumns), a.when(h.dtColumnDefs)]).then(function (e) {
                    ...
                    if (d.isDefined(f) && (j = {}, d.extend(j, f), d.isArray(h) && (j.aoColumns = h), d.isArray(i) && (j.aoColumnDefs = i), j.language && j.language.url)) {
                        var k = a.defer(), l = j.language.url;
        ...
        c.fn.DataTable.Api && c.fn.DataTable.Api.register("ngDestroy()", function (b) {
            return b = b || !1, this.iterator("table", function (d) {
                var e, f = d.nTableWrapper.parentNode, g = d.oClasses, h = d.nTable, i = d.nTBody, j = d.nTHead,
                    k = d.nTFoot, l = c(h), m = c(i), n = c(d.nTableWrapper), o = c.map(d.aoData, function (a) {
                        return a.nTr
                    });
    ...
    function l() {
        ...
        function e(a) {
            return c.extend(!0, c.fn.DataTable.defaults, {language: a}), j
        }

        function f(a) {
            return c.extend(c.fn.DataTable.defaults, {displayLength: a}), j
        }
    ...
    function p(a, b, c, d, e, f, g) {
        function h(h) {
            function i(a, c, e) {
                ...
                var h = b.defer(), i = n.match(/<tbody([\s\S]*)<\/tbody>/i), j = i[1],
    ...
    function t(a) {
        ...
        function f(b, e) {
            ...
            if (!d.isObject(b) || d.isArray(b)) f.resolve(b); else {
                i = d.extend(i, b);
                for (var k in i) i.hasOwnProperty(k) && c.inArray(k, j) === -1 && (d.isArray(i[k]) ? h.push(g(i[k])) : h.push(a.when(i[k])));
                a.all(h).then(function (a) {
                    var b = 0;
                    for (var d in i) i.hasOwnProperty(d) && c.inArray(d, j) === -1 && (i[d] = a[b++]);
                    f.resolve(i)
                })
            }
            return f.promise
